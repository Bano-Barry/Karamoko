...
class RepetiteurProfileForm(forms.ModelForm):
    class Meta:
        model = Repetiteur
        fields = ['avatar', 'biographie', 'competences', 'formations']  # Champs à afficher dans le formulaire
        widgets = {
            'avatar': forms.ClearableFileInput(attrs={
                'class': 'block w-full mt-1 border-gray-300 rounded-md py-4 px-3 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white',
            }),
            'biographie': forms.Textarea(attrs={
                'class': 'block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white',
                'placeholder': 'Entrez une biographie',
