...
SECRET_KEY = 'django-insecure-8g!n4#nu$exe@zswa_j6(3efmkjb+dc5(1j0)$xgxyicvrk^kk'
...
INSTALLED_APPS = [
    ...
    'formations',  # Ajout de l'application formations
    'paiements',  # Ajout de l'application paiements
    'souscriptions',  # Ajout de l'application souscriptions
...
MIDDLEWARE = [
    ...
    'authentication.middlewares.CheckRepetiteurValidationMiddleware',  # Middleware pour vérifier la validation du répétiteur   
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Dossier pour les templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Inclure le dossier static
